...
interface PaddockManager {
  id: number;
  name: string;
  taxNumber: string;
}

interface PaddockType {
  id: number;
  name: "PALTOS" | "AVELLANOS" | "CEREZAS" | "NOGALES";
}
...
const paddockManagers: PaddockManager[] = [
...
//? Un paddock representa una parcela de un campo (Entiéndase también como cuartel o parcela),
